...
Um den Zugriff auf einzelne Einträge zu ermöglichen, sollte jeder Eintrag eine eindeutige ID aufweisen. In JSON können wir diese ID als Schlüssel für den direkten Zugriff verwenden. Dies vereinfacht die Bearbeitug oder Löschung einzelner Einträge. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDI4Mjc2OTIsNjE4NDQ3MTM0LC0xNz
