...
Um den Zugriff auf einzelne Einträge zu ermöglichen, sollte jeder Eintrag eine eindeutige ID aufweisen. In JSON können wir diese ID als Schlüssel für den direkten Zugriff verwenden. Dies vereinfacht die Bearbeitung oder Löschung einzelner Einträge. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxNDY3MTM0MiwtMjAwMjgyNzY5Miw2MT
g0NDcxMzQsLTE3MTQ2MjU5NTYsLTY4ODE0NDAzNV19
-->